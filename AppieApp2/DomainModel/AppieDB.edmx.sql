...
-- --------------------------------------------------
-- Date Created: 01/11/2015 15:44:59
...
IF OBJECT_ID(N'[dbo].[FK_ReceptReceptProduct]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ReceptProductSet] DROP CONSTRAINT [FK_ReceptReceptProduct];
GO
IF OBJECT_ID(N'[dbo].[FK_ProductMerkReceptProduct]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ReceptProductSet] DROP CONSTRAINT [FK_ProductMerkReceptProduct];
GO
